...
import { predictJosaaV2 } from "@/network/v2/predictor";
...
export default function JoSAAPredictorV2() {
  ...
  const { prefill, crlRankLocked, categoryRankLocked, lockMessage } = useMentorshipToolPrefill({
  ...
  const fetchPredictions = async () => {
    ...
    try {
      ...
      const response = await predictJosaaV2(payload);
